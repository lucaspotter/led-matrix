...
# make sure you have either emulator or hardware the same in both main and samplebase! otherwise something WILL break.
...
class SampleBase(object):
    ...
    def process(self):
        ...
        # tbh i just hardcoded my values.
        # makes it all cleaner in the end when i don't have to have 16 trailing args
        ...
        self.matrix = RGBMatrix(options = options)  # what is "self" anyway? everything breaks if i remove it or don't pass it
